                        ...
                        <div>
                            ...
                            <input
                                ...
                                onInput={(e) =>
                                    setAddDraft((d) => ({
                                        ...d,
                                        aliases: (e.target as HTMLInputElement)
                                            .value,
                                    }))
                                }
                                class="w-full text-sm border border-gray-300 rounded-lg px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-[#12956B]"
                    ...
                    <label class="flex items-center gap-2 text-sm text-gray-600 cursor-pointer w-fit">
                        <input
                            ...
                            onChange={(e) =>
                                setAddDraft((d) => ({
                                    ...d,
                                    is_legacy: (e.target as HTMLInputElement)
                                        .checked,
                                }))
                            }
                        />
            ...
            {selectedCategory && !loading && skills.length === 0 && !error && (
                <p class="text-sm text-gray-400 py-4">
                    ...
                    <button
                        ...
                        class="text-[#0F7A4F] hover:underline"
                    >
                        Add one.
                    </button>
                </p>
                    ...
                    <table class="sticky-head w-full text-sm">
                        <thead>
                            <tr class="bg-gray-50 border-b border-gray-200 text-left">
                                <th class="px-4 py-2.5 font-medium text-gray-600 w-1/4">
                                    Canonical name
                                </th>
                                        ...
                                        {isEditing ? (
                                            ...
                                            <>
                                                <td class="px-4 py-2.5 font-medium text-gray-900">
                                                    ...
                                                    {skill.is_legacy && (
                                                        <span class="ml-2 px-1.5 py-0.5 text-xs font-medium bg-amber-50 text-amber-700 border border-amber-200 rounded">
                                                            legacy
                                                        </span>
                                                    )}
                                                </td>
