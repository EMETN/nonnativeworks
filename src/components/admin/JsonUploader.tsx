  ...
  return (
    <div class="space-y-4">
      ...
      <textarea
        ...
        rows={12}
        class="w-full border border-gray-300 rounded-lg px-3 py-2 text-xs font-mono focus:outline-none focus:ring-2 focus:ring-[#16a34a] resize-y"
      />
      ...
      {previewEntries && (() => {
        ...
        return (
          <div class={`border rounded-lg p-3 text-sm ${mismatch ? 'bg-yellow-50 border-yellow-300 text-yellow-800' : 'bg-[#E6ECF6] border-[#99B3DB] text-[#052e16]'}`}>
      ...
      <div class="flex gap-3">
        ...
        <button
          ...
          disabled={!raw.trim() || isLoading}
          class="bg-[#166534] text-white rounded-lg px-4 py-2 text-sm font-medium hover:bg-[#14532d] disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
        >
