      ...
      >
        <div class={`flex items-center ${rowPy} pr-2 sm:pr-4 md:pr-8 xl:pr-12 overflow-hidden min-w-0`}>
          ...
          >
            ...
            {item.englishBadge && (
              <span class="text-[0.4rem] sm:text-xs bg-[#dcfce7] text-[#14532d] px-0.5 sm:px-1.5 py-0.5 rounded font-semibold shrink-0">
                EN
              </span>
            )}
          </div>
        ...
        {compact ? (
          <>
            ...
            <div class={`flex items-center justify-end ${rowPy} pr-2.5 sm:pr-3 md:pr-4 pl-2 sm:pl-4 md:pl-6`}>
              <span class={`${textSize} font-semibold text-[#166534] leading-none tabular-nums`} style={numFont}>
