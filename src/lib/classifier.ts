...
export function classifyJobVerbose(
  ...
  const cleanDesc = descText ? stripProperNouns(descText, companyName) : undefined;
...
export function classifyJob(job: RawJob, countryCode: string, companyName?: string): ClassifiedJob {
