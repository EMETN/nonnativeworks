...
const CITY_MAP: Record<string, CountryInfo> = {
    ...
    munkebo: { name: 'Denmark', code: 'DK', slug: 'denmark' },
    odense: { name: 'Denmark', code: 'DK', slug: 'denmark' },
    ringkøbing: { name: 'Denmark', code: 'DK', slug: 'denmark' },
    ...
    baierbrunn: { name: 'Germany', code: 'DE', slug: 'germany' },
    ...
    brandenburg: { name: 'Germany', code: 'DE', slug: 'germany' },
    ...
    ditzingen: { name: 'Germany', code: 'DE', slug: 'germany' },
    ...
    edertal: { name: 'Germany', code: 'DE', slug: 'germany' },
    ...
    finsing: { name: 'Germany', code: 'DE', slug: 'germany' },
    ...
    gelsenkirchen: { name: 'Germany', code: 'DE', slug: 'germany' },
    'gemünden am main': { name: 'Germany', code: 'DE', slug: 'germany' },
    großkrotzenburg: { name: 'Germany', code: 'DE', slug: 'germany' },
    großmehring: { name: 'Germany', code: 'DE', slug: 'germany' },
    ...
    happurg: { name: 'Germany', code: 'DE', slug: 'germany' },
    ...
    herten: { name: 'Germany', code: 'DE', slug: 'germany' },
    illertissen: { name: 'Germany', code: 'DE', slug: 'germany' },
    ...
    kinsau: { name: 'Germany', code: 'DE', slug: 'germany' },
    ...
    'landsberg am lech': { name: 'Germany', code: 'DE', slug: 'germany' },
    landshut: { name: 'Germany', code: 'DE', slug: 'germany' },
    ...
    niedernberg: { name: 'Germany', code: 'DE', slug: 'germany' },
    ...
    pitzling: { name: 'Germany', code: 'DE', slug: 'germany' },
    ...
    rothenfels: { name: 'Germany', code: 'DE', slug: 'germany' },
    saarbrücken: { name: 'Germany', code: 'DE', slug: 'germany' },
    schenefeld: { name: 'Germany', code: 'DE', slug: 'germany' },
    schweinfurt: { name: 'Germany', code: 'DE', slug: 'germany' },
    ...
    strullendorf: { name: 'Germany', code: 'DE', slug: 'germany' },
    ...
    unterreit: { name: 'Germany', code: 'DE', slug: 'germany' },
    vohburg: { name: 'Germany', code: 'DE', slug: 'germany' },
    ...
    wipfeld: { name: 'Germany', code: 'DE', slug: 'germany' },
    ...
    amstelveen: { name: 'Netherlands', code: 'NL', slug: 'netherlands' },
    ...
    epe: { name: 'Netherlands', code: 'NL', slug: 'netherlands' },
    ...
    velp: { name: 'Netherlands', code: 'NL', slug: 'netherlands' },
    ...
    // Doornik is the Dutch name for Tournai.
    doornik: { name: 'Belgium', code: 'BE', slug: 'belgium' },
    gosselies: { name: 'Belgium', code: 'BE', slug: 'belgium' },
    hasselt: { name: 'Belgium', code: 'BE', slug: 'belgium' },
    herstal: { name: 'Belgium', code: 'BE', slug: 'belgium' },
    kontich: { name: 'Belgium', code: 'BE', slug: 'belgium' },
    kortrijk: { name: 'Belgium', code: 'BE', slug: 'belgium' },
    ...
    'sint-martens-latem': { name: 'Belgium', code: 'BE', slug: 'belgium' },
    tubize: { name: 'Belgium', code: 'BE', slug: 'belgium' },
    // ── Czech Republic ───────────────────────────────────────────────────────
    ...
    // ── France ───────────────────────────────────────────────────────────────
    'aix-en-provence': { name: 'France', code: 'FR', slug: 'france' },
    ...
    cannes: { name: 'France', code: 'FR', slug: 'france' },
    carquefou: { name: 'France', code: 'FR', slug: 'france' },
    cergy: { name: 'France', code: 'FR', slug: 'france' },
    'cesson-sevigné': { name: 'France', code: 'FR', slug: 'france' },
    châtellerault: { name: 'France', code: 'FR', slug: 'france' },
    chatellerault: { name: 'France', code: 'FR', slug: 'france' },
    cholet: { name: 'France', code: 'FR', slug: 'france' },
    colombes: { name: 'France', code: 'FR', slug: 'france' },
    eguilles: { name: 'France', code: 'FR', slug: 'france' },
    elancourt: { name: 'France', code: 'FR', slug: 'france' },
    etrelles: { name: 'France', code: 'FR', slug: 'france' },
    frejus: { name: 'France', code: 'FR', slug: 'france' },
    geispolsheim: { name: 'France', code: 'FR', slug: 'france' },
    gémenos: { name: 'France', code: 'FR', slug: 'france' },
    gennevilliers: { name: 'France', code: 'FR', slug: 'france' },
    grenoble: { name: 'France', code: 'FR', slug: 'france' },
    guipavas: { name: 'France', code: 'FR', slug: 'france' },
    'issy-les-moulineaux': { name: 'France', code: 'FR', slug: 'france' },
    'la chapel saint aubin': { name: 'France', code: 'FR', slug: 'france' },
    'la ciotat': { name: 'France', code: 'FR', slug: 'france' },
    'la ferté-saint-aubin': { name: 'France', code: 'FR', slug: 'france' },
    'la rochelle': { name: 'France', code: 'FR', slug: 'france' },
    'la roche-sur-yon': { name: 'France', code: 'FR', slug: 'france' },
    laval: { name: 'France', code: 'FR', slug: 'france' },
    'le plessis-robinson': { name: 'France', code: 'FR', slug: 'france' },
    ...
    limours: { name: 'France', code: 'FR', slug: 'france' },
    lyon: { name: 'France', code: 'FR', slug: 'france' },
    marseille: { name: 'France', code: 'FR', slug: 'france' },
    massy: { name: 'France', code: 'FR', slug: 'france' },
    merignac: { name: 'France', code: 'FR', slug: 'france' },
    metz: { name: 'France', code: 'FR', slug: 'france' },
    meudon: { name: 'France', code: 'FR', slug: 'france' },
    meyreuil: { name: 'France', code: 'FR', slug: 'france' },
    moirans: { name: 'France', code: 'FR', slug: 'france' },
    ...
    orléans: { name: 'France', code: 'FR', slug: 'france' },
    ormes: { name: 'France', code: 'FR', slug: 'france' },
    palaiseau: { name: 'France', code: 'FR', slug: 'france' },
    paris: { name: 'France', code: 'FR', slug: 'france' },
    pau: { name: 'France', code: 'FR', slug: 'france' },
    'pont-audemer': { name: 'France', code: 'FR', slug: 'france' },
    ...
    rungis: { name: 'France', code: 'FR', slug: 'france' },
    'sainghin-en-mélantois': { name: 'France', code: 'FR', slug: 'france' },
    'saint-étienne': { name: 'France', code: 'FR', slug: 'france' },
    ...
    'sophia antipolis': { name: 'France', code: 'FR', slug: 'france' },
    ...
    toulon: { name: 'France', code: 'FR', slug: 'france' },
    ...
    valence: { name: 'France', code: 'FR', slug: 'france' },
    vallauris: { name: 'France', code: 'FR', slug: 'france' },
    velaux: { name: 'France', code: 'FR', slug: 'france' },
    'vélizy-villacoublay': { name: 'France', code: 'FR', slug: 'france' },
    vendome: { name: 'France', code: 'FR', slug: 'france' },
    'verneuil en halatte': { name: 'France', code: 'FR', slug: 'france' },
    'villebon-sur-yvette': { name: 'France', code: 'FR', slug: 'france' },
    ...
    tczew: { name: 'Poland', code: 'PL', slug: 'poland' },
    tychy: { name: 'Poland', code: 'PL', slug: 'poland' },
    szczecin: { name: 'Poland', code: 'PL', slug: 'poland' },
    ...
    lausanne: { name: 'Switzerland', code: 'CH', slug: 'switzerland' },
    sion: { name: 'Switzerland', code: 'CH', slug: 'switzerland' },
    thun: { name: 'Switzerland', code: 'CH', slug: 'switzerland' },
...
const COMPANY_COUNTRY_FALLBACKS: Array<{
    urlSubstring: string;
    country: CountryInfo;
}> = [
    {
        urlSubstring: 'academicwork.fi',
    ...
    {
        urlSubstring: 'upcloud.teamtailor.com',
        country: { name: 'Finland', code: 'FI', slug: 'finland' },
    },
];
 ...
 */
export function getCompanyCountryFallback(
    careerUrl: string,
): CountryInfo | null {
 ...
 */
export function extractWorkModelFromLocation(
    location: string,
    ...
    for (const part of parts) {
        ...
        if (match) {
            ...
            else if (raw === 'onsite' || raw === 'inoffice')
                models.add('on-site');
        }
    }
    if (models.size === 1)
        return [...models][0] as 'remote' | 'hybrid' | 'on-site';
    return null;
}
...
export function lookupCountryFromLocation(location: string): CountryInfo[] {
    ...
    for (const segment of segments) {
        const key = normalizeKey(segment);
        const info =
            COUNTRY_MAP[key] ?? CITY_MAP[key] ?? lookupCityByPrefix(key);
    ...
    const leadingCode = fullKey.match(
        /^([a-z]{2})(?:\s*-|[a-z]*[0-9][a-z0-9]*)/,
    );
    if (leadingCode) {
