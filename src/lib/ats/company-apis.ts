...
export const COMPANY_NAME_OVERRIDES: Array<{
    ...
    { urlSubstring: 'wpp.careersitecloud.com', name: 'WPP' },
    { urlSubstring: 'theheinekencompany.com', name: 'Heineken' },
];
