...
const CATEGORY_KEYWORDS: Record<string, string[]> = {
  ...
  'data-analytics': [
    'data scientist', 'data engineer', 'data analyst', 'data analysis',
    ...
    'data warehouse', 'big data', 'statistician', 'quantitative analyst',
    'research scientist', 'mlops',
  ],
  product: [
  ...
  'customer-support': [
    ...
    'helpdesk', 'help desk', 'service desk', 'technical support',
  ...
  'hr-recruiting': [
    ...
    'hr manager', 'hr director', 'chief people', 'payroll',
