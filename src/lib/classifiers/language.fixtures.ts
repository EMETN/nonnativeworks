...
export const CASES: FixtureCase[] = [
    ...
    // ── Phase 2a/1b: Advantage-cue and language-list-gap fixes ────────────────

    {
        label: '2a negation-advantage — "Spanish language skills are welcome" → advantage ("welcome" cue)',
        title: 'Sales Representative',
        desc: 'Spanish language skills are welcome.',
        country: 'DE',
        requires: false,
        advantage: true,
    },
    {
        label: '1b — "Dutch and other European languages are highly valued" → advantage ("and" connector + "valued")',
        title: 'Account Manager',
        desc: 'Fluent English is required. Dutch and other European languages are highly valued.',
        country: 'NL',
        requires: false,
        advantage: true,
    },
    {
        label: '2a negation-advantage — "fluency in Swedish, Danish or Norwegian would be beneficial" → advantage (language-list gap before cue)',
        title: 'Customer Success Manager',
        desc: 'Fluency in English is required, fluency in Swedish, Danish or Norwegian would be beneficial.',
        country: 'SE',
        requires: false,
        advantage: true,
    },
