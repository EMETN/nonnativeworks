...
-- This is the consolidated version of all incremental migrations (001–013).
...
-- Top companies by English-friendly position count, deduplicated across the
-- countries a company operates in. primary_country_slug/career_page_url come
-- from whichever of the company's per-country rows has the most English positions.
